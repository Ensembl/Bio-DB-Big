...
=head is_autogenerated()

Looks at the comment and field name and attmepts to divine if the field was an autogenerated one or not i.e. when a BigBed file was created no AutoSQL definition was given to bedToBigBed and the tool created placeholder fields. This happens if the name is formatted as C<field8> or the comment was C<Undocumented field>.

=cut

sub is_autogenerated {
  my ($self) = @_;
  return ($self->name =~ /^field\d+$/ || $self->comment eq 'Undocumented field') ? 1 : 0;
}
